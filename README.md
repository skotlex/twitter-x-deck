...
이 기능만은 브라우저 안에서 끝나지 않습니다. 이 PC 에 깔린 `codex` · `claude` 명령과 그 **구독 계정** 을 그대로 빌려 쓰며, 둘 사이를 잇는 작은 프로그램([bridge/](bridge/README.md))을 **한 번** 등록해야 합니다. 별도 API 키나 추가 요금은 필요하지 않습니다.
