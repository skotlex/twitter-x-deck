...
- `https://x.com` 에서 온 요청만 받습니다
- 모든 요청에 열쇠를 확인합니다. localhost 서버는 이 PC 의 어떤 프로그램이든 두드릴 수 있고, 출처 검사만으로는 부족합니다 — 덱도 x.com 에서 돌아 출처가 같기 때문입니다
- 열쇠는 브리지가 처음 뜰 때 만들어 `bridge/.bridge-token` 에 두며, 저장소에 올라가지 않습니다
