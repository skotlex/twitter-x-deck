...
설정의 **x.com 열면 덱으로** 가 켜져 있으면(기본값) 평소처럼 `x.com/home` 에 들어가도 덱이 뜹니다. 게시물 · 프로필 등 나머지 주소는 덮지 않으므로 원본 화면을 그대로 쓸 수 있습니다.
...
| 스크롤 중 대기 | 목록을 내려 읽는 동안 새 글을 끼워넣지 않고 상단 배지에 모아둡니다 |
